<div class="relative group w-[400px] max-sm:w-full" x-data="{ open: false }">
    ...
    <div id="dropdown-menu" x-bind:class="! open ? 'hidden' : ''" class="w-full absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 p-1 space-y-1 {{ $zIndex }} overflow-y-auto max-h-[400px] relative pt-0">
        <!-- Search input -->
