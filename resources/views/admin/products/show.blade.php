    ...
    <div class="card w-96 bg-base-100 shadow-xl border-2">
        <div class="card-body">
            <div class="flex justify-between">
                ...
                <a class="btn" href="{{route('admin.products.index')}}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
